  ...
  return (
    <div className="flex items-center justify-center h-screen bg-primary">
      ...
      >
        ...
        <p className="text-gray-500 text-sm mt-2">Please Signup to continue</p>
        ...
        <button className="mt-2 w-full h-11 rounded-full text-white bg-primary hover:opacity-90 transition-opacity cursor-pointer">
          Signup
        </button>
